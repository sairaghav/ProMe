...
def get_risk(street: str, from_date: str, to_date: str) -> dict:
    ...
    results['all_top_tag_1'] = all_tag_counter.most_common(1)
    results['all_top_tag_3'] = all_tag_counter.most_common(3)
    results['all_top_tag_5'] = all_tag_counter.most_common(5)
    results['user_tags'] = dict(user_tag_counter)
    results['user_top_tag_1'] = user_tag_counter.most_common(1)
    results['user_top_tag_3'] = user_tag_counter.most_common(3)
    results['user_top_tag_5'] = user_tag_counter.most_common(5)

    results['all_timeline'] = dict(all_timeline_counter)
    results['all_top_timeline_1'] = all_timeline_counter.most_common(1)
    results['all_top_timeline_3'] = all_timeline_counter.most_common(3)
    results['all_top_timeline_5'] = all_timeline_counter.most_common(5)
    results['user_timeline'] = dict(user_timeline_counter)
    results['user_top_timeline_1'] = user_timeline_counter.most_common(1)
    results['user_top_timeline_3'] = user_timeline_counter.most_common(3)
    results['user_top_timeline_5'] = user_timeline_counter.most_common(5)
